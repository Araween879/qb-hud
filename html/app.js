...
function restartHud() {
    closeMenu();
    fetch(`https://${GetParentResourceName()}/restartHud`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function resetStorage() {
    closeMenu();
    fetch(`https://${GetParentResourceName()}/resetStorage`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showOutMap() {
    fetch(`https://${GetParentResourceName()}/showOutMap`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showOutCompass() {
    fetch(`https://${GetParentResourceName()}/showOutCompass`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showFollowCompass() {
    fetch(`https://${GetParentResourceName()}/showFollowCompass`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function openMenuSounds() {
    fetch(`https://${GetParentResourceName()}/openMenuSounds`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function resetHudSounds() {
    fetch(`https://${GetParentResourceName()}/resetHudSounds`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function checklistSounds() {
    fetch(`https://${GetParentResourceName()}/checklistSounds`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showMapNotif() {
    fetch(`https://${GetParentResourceName()}/showMapNotif`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showFuelAlert() {
    fetch(`https://${GetParentResourceName()}/showFuelAlert`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showCinematicNotif() {
    fetch(`https://${GetParentResourceName()}/showCinematicNotif`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function dynamicHealth() {
    fetch(`https://${GetParentResourceName()}/dynamicHealth`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function dynamicArmor() {
    fetch(`https://${GetParentResourceName()}/dynamicArmor`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function dynamicHunger() {
    fetch(`https://${GetParentResourceName()}/dynamicHunger`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function dynamicThirst() {
    fetch(`https://${GetParentResourceName()}/dynamicThirst`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function dynamicStress() {
    fetch(`https://${GetParentResourceName()}/dynamicStress`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function dynamicOxygen() {
    fetch(`https://${GetParentResourceName()}/dynamicOxygen`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function dynamicEngine() {
    fetch(`https://${GetParentResourceName()}/dynamicEngine`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function dynamicNitro() {
    fetch(`https://${GetParentResourceName()}/dynamicNitro`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function ToggleMapShape() {
    fetch(`https://${GetParentResourceName()}/ToggleMapShape`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function changeFPS() {
    fetch(`https://${GetParentResourceName()}/changeFPS`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function ToggleMapBorders() {
    fetch(`https://${GetParentResourceName()}/ToggleMapBorders`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function HideMap() {
    fetch(`https://${GetParentResourceName()}/HideMap`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function changeCompassFPS() {
    fetch(`https://${GetParentResourceName()}/changeCompassFPS`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showCompassBase() {
    fetch(`https://${GetParentResourceName()}/showCompassBase`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showStreetsNames() {
    fetch(`https://${GetParentResourceName()}/showStreetsNames`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showPointerIndex() {
    fetch(`https://${GetParentResourceName()}/showPointerIndex`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function showDegreesNum() {
    fetch(`https://${GetParentResourceName()}/showDegreesNum`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
function cinematicMode() {
    fetch(`https://${GetParentResourceName()}/cinematicMode`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({})
    });
...
const neonNavigationHud = Vue.createApp({
    data() {
        return {
            destination: "VINEWOOD HILLS",
            distance: "3.4KM",
            serverTime: "01:36",
            showHealth: true,
            showArmor: true,
        ...
        this.listener = window.addEventListener("message", (event) => {
            switch (event.data.action) {
                ...
                case "updateServerTime":
                    this.updateServerTime(event.data);
                    break;
                case "updateNeonHud":
                    this.updateNeonHud(event.data);
                    break;
            }
        });
    ...
    methods: {
        ...
        updateServerTime(data) {
            this.serverTime = data.time || this.serverTime;
        },
        updateNeonHud(data) {
            ...
            this.showHealth = data.showHealth !== undefined ? data.showHealth : this.showHealth;
            this.showArmor = data.showArmor !== undefined ? data.showArmor : this.showArmor;
            this.showHunger = data.showHunger !== undefined ? data.showHunger : this.showHunger;
            this.showThirst = data.showThirst !== undefined ? data.showThirst : this.showThirst;
            this.showStress = data.showStress !== undefined ? data.showStress : this.showStress;
            this.showOxygen = data.showOxygen !== undefined ? data.showOxygen : this.showOxygen;
        },
        updateTimeInterval() {
            setInterval(() => {
                const now = new Date();
                this.serverTime = now.toLocaleTimeString('en-US', { 
                    hour12: false, 
                    hour: '2-digit', 
                    minute: '2-digit' 
                });
...
}).mount("#neon-navigation-container");
...
const playerHud = {
    ...
    methods: {
        hudTick(data) {
            ...
            // Update Neon HUD
            neonNavigationHud.updateNeonHud({
                health: this.health,
                armor: this.armor,
                hunger: this.hunger,
                thirst: this.thirst,
